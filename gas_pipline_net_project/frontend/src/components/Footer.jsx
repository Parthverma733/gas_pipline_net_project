  ...
  return (
    <div className="footer" id='FOOTER'>
      <div className="footer_head">
        <img src="..\src\assets\images\team.jpg" alt="" height={100} />
     ...
     <div className="first">
          ...
          <img src="..\src\assets\images\team_member.svg" alt="" width={130} />
      ...
      <div className="foot">
        ...
        <div className="foot_inner">
          <img src="..\src\assets\images\graphic.jpeg" alt="" height={50} />
